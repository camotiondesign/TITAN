...
- `content/`
  ...
  - `poll/poll.md` – Poll question, options, and context (if exists).
...
- `social/`
  ...
  - `linkedin/_example-poll/` – One LinkedIn poll (same structure).
...
3. **Drop in content**
   ...
   - Document poll question and options in `content/poll/poll.md` (if exists).
